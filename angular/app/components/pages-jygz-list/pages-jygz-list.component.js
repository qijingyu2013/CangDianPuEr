...
export const PagesJygzListComponent = {
  templateUrl: './views/app/components/pages-jygz-list/pages-jygz-list.component.html',
  controller: PagesJygzListController,
  controllerAs: 'vm',
  bindings: {}
}
