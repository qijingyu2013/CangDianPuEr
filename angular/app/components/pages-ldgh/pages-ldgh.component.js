...
export const PagesLdghComponent = {
  templateUrl: './views/app/components/pages-ldgh/pages-ldgh.component.html',
  controller: PagesLdghController,
  controllerAs: 'vm',
  bindings: {}
}
