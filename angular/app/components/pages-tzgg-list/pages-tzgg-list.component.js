...
export const PagesTzggListComponent = {
  templateUrl: './views/app/components/pages-tzgg-list/pages-tzgg-list.component.html',
  controller: PagesTzggListController,
  controllerAs: 'vm',
  bindings: {}
}
